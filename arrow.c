...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/06/16 17:13:08 by csimon            #+#    #+#             */
/*   Updated: 2017/06/16 17:13:10 by csimon           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	arrow_bar(float x, float y, float *c, t_data *data)
{
	float	zr;
	float	zi;
	int		i;
...
void	arrow_foo(t_data *data, float x, float y, char *img_str)
{
	float	c[2];
	float	img_x;
	float	img_y;
...
int		my_mouse9(int button, int x, int y, void *data)
{
	t_data	*s;
	char	*str;
...
int		arrow(void)
{
	...
	arrow_foo(data, (LEN / 4), (LEN / 3), img_str);
